...
function initEventos() {
  document
    .getElementById("btnGuardarAccion")
    .addEventListener("click", guardarAccion);
...
takeBtn.onclick = async () => {
  if (fotosFiles.length >= 5) return alert("Máx. 5 fotos.");
